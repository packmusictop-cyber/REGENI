...
async function main() {
  ...
  const files = [
    { file: path.join(SCRIPT_DIR, 'data', '41corrida_5km_results.json'), mod: '5KM' },
    { file: path.join(SCRIPT_DIR, 'data', '41corrida_10km_results.json'), mod: '10KM' },
    { file: path.join(SCRIPT_DIR, 'data', '41corrida_24km_results.json'), mod: '24KM' },
  ];
